...
The repository is based on the work [From Sketch to Structure: Agentic Prompting for Business Process Diagram Understanding With Vision–Language Models](https://ieeexplore.ieee.org/abstract/document/11456921).
